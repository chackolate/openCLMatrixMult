...
#pragma message(                                                               \
    "cl_version.h: CL_TARGET_OPENCL_VERSION is not defined. Defaulting to 200 (OpenCL 2.0)")
...
#pragma message(                                                               \
    "cl_version: CL_TARGET_OPENCL_VERSION is not a valid value (100, 110, 120, 200, 210, 220, 300). Defaulting to 200 (OpenCL 2.0)")
